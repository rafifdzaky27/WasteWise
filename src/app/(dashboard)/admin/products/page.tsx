...
export default function AdminProductsPage() {
  ...
  const [form, setForm] = useState({ name: "", description: "", price_rp: "", stock_qty: "", category: "compost", image_url: "" });
  ...
  async function handleAdd() {
    ...
    try {
      ...
      if (!res.ok) { setMsg({ type: "error", text: data.error }); }
        ...
        setForm({ name: "", description: "", price_rp: "", stock_qty: "", category: "compost", image_url: "" });
        setShowForm(false);
