...
export default function RewardsPage() {
  ...
  if (loading) return (
    <div className="max-w-5xl mx-auto pb-20 md:pb-0 animate-pulse space-y-4">
      <div className="h-8 bg-stone-light rounded w-48" />
      <div className="h-32 bg-stone-light rounded-2xl" />
    </div>
  );
