...
const metrics = [
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
        <path d="M15 13V5C15 3.34 13.66 2 12 2S9 3.34 9 5V13C6.79 14.66 6.34 17.79 8 20C9.66 22.21 12.79 22.66 15 21C17.21 19.34 17.66 16.21 16 14C15.72 13.62 15.38 13.28 15 13ZM12 4C12.55 4 13 4.45 13 5V8H11V5C11 4.45 11.45 4 12 4Z" fill="#016630"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
        <path d="M12 2C6 12 4 15.54 4 18C4 22 7.58 22 12 22C16.42 22 20 22 20 18C20 15.54 18 12 12 2ZM7 18C7 15.83 8.56 13.21 12 8.38C15.44 13.21 17 15.83 17 18C17 19.64 16.21 20 12 20C7.79 20 7 19.64 7 18Z" fill="#3B82F6"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
        <path d="M12 2L1 21H23L12 2ZM12 6L19.53 19H4.47L12 6ZM11 10V14H13V10H11ZM11 16V18H13V16H11Z" fill="#F59E0B"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
        <path d="M11.99 2C6.47 2 2 6.48 2 12C2 17.52 6.47 22 11.99 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 11.99 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20ZM12.5 7H11V13L16.25 16.15L17 14.92L12.5 12.25V7Z" fill="#A855F7"/>
      </svg>
    ),
  },
];
